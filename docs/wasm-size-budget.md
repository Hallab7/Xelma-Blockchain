...
1. Build locally: `cargo build --target wasm32-unknown-unknown --release --package xelma-contract`
2. Measure: `wc -c < target/wasm32-unknown-unknown/release/xelma_contract.wasm`

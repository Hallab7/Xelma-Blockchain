...
export interface Client {
  ...
  // TODO(Issue #268): regenerate bindings via `stellar contract bindings typescript`
  // after recompiling the contract. The base64 ContractSpec below and the types
  // above were hand-edited and may be out of sync.

...
use crate::types::{
    ArchivedRoundSummary, BetSide, DataKey, MultiFeedPayload, OraclePayload, OracleQuorumConfig,
    PrecisionCommitment, PrecisionPrediction, Round, RoundArchiveStatus, RoundMode,
...
fn _settle_round_with_price(
    ...
    env.events().publish(
        ...
        (round_id, final_price, mode_value, confidence),
    );
